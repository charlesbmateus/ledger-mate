<div class="fixed bg-indigo-600 w-16 sm:w-60 min-h-screen pt-4 transition-all">

    <!-- Dashboard Link -->
    <ul class="mt-8">
        <li class="hover:bg-indigo-800 cursor-pointer h-12 flex">
            <x-nav-link class="grid gap-4 w-full sm:flex text-white font-semibold tracking-wide transition-colors px-4 pt-1 items-center" href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" >
                ...
                <span class="hidden sm:block text-base">
                {{ __('Dashboard') }}
                </span>
            </x-nav-link>
        </li>
        ...
        <!-- Dashboard Link -->
        <li class="hover:bg-indigo-800 cursor-pointer h-12 flex">
            <x-nav-link class="grid gap-4 w-full sm:flex text-white font-semibold tracking-wide transition-colors px-4 pt-1 items-center" href="#" :active="request()->routeIs('video')" >
                <svg width="24" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li class="hover:bg-indigo-800 cursor-pointer px-4 h-12 flex items-center">
            ...
            <span class="ml-3 hidden sm:block  text-white font-semibold tracking-wide hover:text-white transition-colors"> Search</span>
        </li>
        <li class="hover:bg-indigo-800 cursor-pointer  px-4 h-12 flex items-center">
            ...
            <span class="ml-3 hidden sm:block text-white font-semibold tracking-wide hover:text-white transition-colors"> Downloads</span>
        </li>
        <li class="hover:bg-indigo-800 cursor-pointer  px-4 h-12 flex items-center">
            ...
            <span class="ml-3 hidden sm:block  text-white font-semibold tracking-wide hover:text-white transition-colors"> Shop</span>
        </li>
        <li class="hover:bg-indigo-800 cursor-pointer  px-4 h-12 flex items-center">
            ...
            <span class="ml-3 hidden sm:block text-white font-semibold tracking-wide hover:text-white transition-colors"> Trash</span>
        </li>
    </ul>
</div>
